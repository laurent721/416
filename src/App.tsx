...
*극장 내부는 암전 상태입니다. 안전사고에 유의해 주시기 바랍니다.
La salle de spectacle est plongée dans l'obscurité. Veuillez faire attention afin d'éviter tout accident possible.
*극장 내부에서 셔터음 및 플래시를 사용하지 않은 촬영은 가능합니다.
Il est possible de prendre des photos à l'intérieur du théâtre, à condition de ne pas utiliser le flash et de ne pas faire de bruit avec l'obturateur.
*극장 내부에서 휴대전화 이용시 화면의 밝기를 낮추어 주세요.
Veuillez baisser la luminosité de l'écran lorsque vous utilisez votre téléphone portable dans le théâtre.
*방문자는 자유롭게 극장을 드나들 수 있습니다.
Les visiteurs peuvent entrer et sortir librement du théâtre.
*극장 내부에서 동행인과의 대화는 작게 해 주세요.
Veuillez garder vos conversations avec vos compagnons discrètes à l'intérieur du théâtre.
*퍼포먼스 중인 퍼포머에게는 대화를 시도할 수 없습니다.
Il est interdit de tenter de parler à un artiste qui est en train de se produire.
*퍼포머의 퍼포먼스를 고의적으로 지연 또는 방해하는 행위는 엄격히 제한됩니다.
Il est strictement interdit de retarder ou de perturber intentionnellement le travail d'un artiste.
*극장 내외부에서는 정치적 홍보 및 종교적 포교 활동이 불가합니다. 
Toute promotion politique et activité de prosélytisme religieux est interdite à l'intérieur comme à l'extérieur du théâtre.
*안전사고 예방을 위해 무대 장치는 만질 수 없습니다.
Pour éviter tout accident, il est interdit de toucher au matériel scénique.
*휠체어 입장을 원하시는 경우 문의해 주시기 바랍니다.
...
We often refer to the psychological scars left by a disaster as ‘trauma’ and define them as something to be treated and overcome. But must we view trauma solely as something that must be treated and overcome? A, who witnessed the sinking of the Sewol ferry from school on 16 April, testifies that even today, 12 years later, she has lived her life unconsciously pushing away the memories of that day. This is because even the act of searching for related news articles was too painful and overwhelming. A says that even those repressed years ultimately form part of who they are today. Perhaps trauma is not a stain to be erased, but a layer of life that must be embraced and lived with. Emotions and actions—such as the occurrence of the event, witnessing it, the shock, mourning, and turning away—are intertwined to create the ‘me’ of today. Consider a mille-crêpe cake. Thin layers, stacked one upon another, come together to form a single entity: the cake. Yet the layer at the very bottom and the layer at the very top inevitably possess different textures. As time passes, the layers that once had distinct boundaries gradually fade and may even merge into one another. Reflecting on accumulated memories is not about forcibly exposing and dissecting these layers. Nor is it about cutting them open with a knife to examine the cross-section. It is a process of fully observing the very form in which they exist. That process of contemplation will be the very centre of this moment in time and space.`,
  ...
  FR: [
    `Le mot de l'auteur
Certaines ténèbres ne cachent pas leur existence face à la lumière. Il y a des gens qui vivent en gardant un peu de ces ténèbres dans leur cœur. Tout comme on ne peut point effacer les traces de sang sur la chair d’un poisson meurtri, même en la découpant à l’infini, ce sont des gens qui vivent en considérant ces ténèbres comme une partie intégrante de leur cœur. On peut peut-être les trouver assez facilement. Dans notre théâtre, des histoires sur les ténèbres que chacun porte en soi seront racontées. Des histoires sur ces ténèbres apparuent par hasard il y a longtemps, sur ces ténèbres que l’on a ignorées jusqu’à présent. Depuis que ces ténèbres ont pris place dans mon cœur, j’ai eu par hasard vingt ans, je suis entré par hasard à l’université, j’ai obtenu par hasard mon diplôme, j’ai terminé par hasard mon service militaire, je suis entré par hasard en master et je passe par hasard les derniers moments de ma vingtaine. Jusqu’à présent, j’ai fui ces ténèbres — j’ai essayé de la fuir — mais l’idée m’est venue par hasard : et si, je l’affrontais à nouveau ? Le théâtre qui abrite mes ténèbres devient à la fois ma chambre secrète et un immense laboratoire. Tout au long de la journée, nous sentirons q, nous sentirons que les ténèbres  qui remplit le théâtre vit et évolue au rythme de notre temps. 
...
Il y a de certaines ténèbres dans le théâtre.`,
